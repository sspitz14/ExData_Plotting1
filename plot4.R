...
# plot upleft
with(hpc, plot(Date.Time, Global_active_power, type="l", font.axis=2, font.lab=2, xlab="", ylab="Global Active Power"))
# plot upright
with(hpc, plot(Date.Time, Voltage, type="l", font.lab=2, yaxt="n", xlab="datetime", ylab="Voltage"))
axis(2, font.axis=2, at=seq(234, 246, by=2),labels=c("234", "", "238", "", "242", "", "246"), col.axis="black", las=0)
# plot botleft
...
# plot botright
with(hpc, plot(Date.Time, Global_reactive_power, type="l", font.axis=2, font.lab=2, xlab="datetime"))
